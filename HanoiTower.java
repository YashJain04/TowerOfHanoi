...
//COMMENTS
//The HanoiTowerFile was given to us
//All of this code was given to us from the A3 Files
...
public class HanoiTower {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            disks++;
            System.out.println("Type Y or y to play again, otherwise type anything else to end game and terminate program.");
